...
export default function HomePage() {
    ...
    return(
        <div className="w-full overflow-hidden">
            ...
            <div className='flex items-center justify-center' style={{ height: `${height+75}px`}}>
            ...
            <div className="h-[50px] bg-stone-200">
              <div 
                ...
                >
                  <div 
                    className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-slate-800 via-blue-600 to-stone-200 transform -rotate-1.5 origin-top-left"
                  />
              </div>
            </div>
